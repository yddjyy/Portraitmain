...
import top.ingxx.kafka.KafkaEventSchema;
import top.ingxx.map.ChaomanAndwomenMap;
import top.ingxx.map.ChaomanAndwomenbyreduceMap;
import top.ingxx.reduce.ChaoManAndWomenSink;
import top.ingxx.reduce.ChaomanandwomenReduce;
import top.ingxx.reduce.ChaomanwomenfinalReduce;

public class ChaomanandwomenTask {
    public static void main(String[] args) {
        // parse input arguments
        args = new String[]{"--input-topic","scanProductLog","--bootstrap.servers","192.168.73.104:9092","--zookeeper.connect","192.168.73.104:2181","--group.id","brd"};
